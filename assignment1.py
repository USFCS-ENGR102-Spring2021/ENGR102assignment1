...
### Question 2. write a function that takes a distance in miles and a velocity in MPH
### and returns the equivalent velocity in KM/second. Make use of the functions from question 1 as necessary.
